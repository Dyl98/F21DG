...
<?php
	function get_staff_info($staffid) {
		...
		$staff_info = $sql_connection->query_database("SELECT * FROM staff_members WHERE staffid = ".$staffid.";");
...
<?php
	function get_modules_by_staff($staffid) {
		$sql_connection = new mySQLi_helper();
		$modules_by_staff = $sql_connection->query_database("SELECT DISTINCT * FROM current_modules, current_modules_xref WHERE current_modules.moduleid = current_modules_xref.moduleid AND current_modules_xref.staffid = '".$staffid."';");
...
<?php
	function get_tasks_by_staff($staffid) {
		$sql_connection = new mySQLi_helper();
		$tasks_by_staff = $sql_connection->query_database("SELECT DISTINCT * FROM admin_tasks, admin_tasks_xref WHERE admin_tasks.adminid = admin_tasks_xref.adminid AND admin_tasks_xref.staffid = '".$staffid."';");
...
<?php
	function get_duties_by_staff($staffid) {
		$sql_connection = new mySQLi_helper();
		$duties_by_staff = $sql_connection->query_database("SELECT DISTINCT * FROM research_duties, research_duties_xref WHERE research_duties.researchid = research_duties_xref.researchid AND research_duties_xref.staffid = '".$staffid."';");
...
<?php
	function get_module_info($moduleid) {
		$sql_connection = new mySQLi_helper();
		$module_info = $sql_connection->query_database("SELECT * FROM current_modules WHERE moduleid = ".$moduleid.";");
...
<?php
	function get_staff_by_module($moduleid) {
		$sql_connection = new mySQLi_helper();
		$staff_by_module = $sql_connection->query_database("SELECT DISTINCT * FROM staff_members, current_modules_xref WHERE staff_members.staffid = current_modules_xref.staffid AND current_modules_xref.moduleid = '".$moduleid."';");
...
<?php
	function get_admin_info($adminid) {
		$sql_connection = new mySQLi_helper();
		$admin_info = $sql_connection->query_database("SELECT * FROM admin_tasks WHERE adminid = ".$adminid.";");
...
<?php
	function get_staff_by_admin($adminid) {
		$sql_connection = new mySQLi_helper();
		$staff_by_admin = $sql_connection->query_database("SELECT DISTINCT * FROM staff_members, admin_tasks_xref WHERE staff_members.staffid = admin_tasks_xref.staffid AND admin_tasks_xref.adminid = '".$adminid."';");
...
<?php
	function get_research_info($researchid) {
		$sql_connection = new mySQLi_helper();
		$research_info = $sql_connection->query_database("SELECT * FROM research_duties WHERE researchid = ".$researchid.";");
...
<?php
	function get_staff_by_research($researchid) {
		$sql_connection = new mySQLi_helper();
		$staff_by_research = $sql_connection->query_database("SELECT DISTINCT * FROM staff_members, research_duties_xref WHERE staff_members.staffid = research_duties_xref.staffid AND research_duties_xref.researchid = '".$researchid."';");
